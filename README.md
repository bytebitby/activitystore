...
# Bitrix24 Activity Store (MVP)

## Описание
MVP-приложение маркетплейса активностей для Bitrix24 BizProc.
Позволяет:
- устанавливать приложение в портал
- сохранять порталы (multi-tenant)
- регистрировать тестовые активности в Bitrix24
- управлять состоянием активностей

---

## Архитектура

- `install.php` — установка приложения в портал Bitrix24
- `portals.json` — хранение установленных порталов
- `market_toggle.php` — регистрация/активация активностей
- `ActivityRegistry` — каталог доступных активностей
- `handler.php` — вход для BizProc активностей

---

## Статус MVP

✔ install flow работает  
✔ портал сохраняется и обновляется  
✔ bizproc activity registration работает  
...
- state layer (activity_states.json)
- защита от дублей регистрации
- UI витрина внутри Bitrix24